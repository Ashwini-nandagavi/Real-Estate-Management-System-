...
<!-- end of header-->
  ...
  <tr>
    ...
    if(!$connect)
    {
      ...
      $pquery="select * from addproperty where pcategory='Bungalow'";
  ...
  <td>
    <div class="card" >
      <?php echo '<img src="data:IMAGES\jpg;base64,'.base64_encode($row['image']).'" width="100%" height="140">';?>
      
    <h1><?php echo $row['pname']; ?></h1>
    <p class="price">RS.<?php echo $row['pprice']; ?></p>
    <p>Area:<?php echo $row['parea']; ?> sqft<br>
    This property has 4BHK with pool and garder<?php echo $row['pdes']; ?></p>
    <p>address:<?php echo $row['padr']; ?></p>
    <p><button><a onclick="userfun()">Book Now</button></a></p>
    </div>
   </td>
  ...
  <tr>
   ...
   $connect=mysqli_connect("localhost","root","","paradise");
    if(!$connect)
    {
      ...
      $pquery="select * from addproperty  where pcategory='Villa'";
      $result=mysqli_query($connect,$pquery) or die("could not execute query");
      while($row=mysqli_fetch_array($result))
      {
...
<div class="usersignup1" style="height:900">
  ...
  <input type="text"  name="fname" id="fname" style="width: 95%; height:15px; border-radius:12px; border:2px solid black;">

    <label style="color:rgb(0, 0, 0) ;font-size: 16px;">Email Address</label>
    <input type="text" name="email" id="email" style="width: 95%; height:15px; border-radius:12px; border:2px solid black;" >

    <label style="color:rgb(0, 0, 0) ;font-size: 16px;">Password</label>
    <input type="password" name="pwd" id="pwd" style="width: 95%; height:15px; border-radius:12px; border-color: black;border:2px solid black;"><br>

    <label style="color:rgb(0, 0, 0) ;font-size: 16px; ">Confirm Password</label>
    <input type="password" name="cpwd" id="cpwd" style="width: 95%; height:15px;border-radius:12px;border:2px solid black;">

    <label style="color:rgb(0, 0, 0) ;font-size: 16px;">Phone</label>
    <input type="text" name="mob"  id="mob" style="width: 95%; height:15px; border-radius:12px;border:2px solid black;">
...
<div class="asignincenter asigninmodal-box" style="background-color: rgb(53, 158, 232);">
 ...
 <div class="asiginbtns">
   ...
   <div class="cbtn1">
     <input type="reset" value="clear" style="height:38px;padding:10px;"/>
   </div>
 </div>
       <br>
       <div class="closesignin">
...
<div class="tsignincenter tsigninmodal-box" style="background-color: rgb(53, 158, 232);">
  <center><img src="IMAGES/user2.jpg" style="border-radius: 50%;height: 30px; width: 35px;"/></center>
...
<input type="text" name="mob" placeholder="Enter Mobile no" style="width:93%;"/>

<label> Hint:</label>
<input type="password" name="hint" placeholder="Enter Hint" style="margin-left:2px; width:93%;"/>

<input type="submit" name="ForgotPassword1" value="ForgotPassword" class="btn" style="margin-left:50px;"/>
<input type="reset" value="clear" class="btn"/>
</form>
</div>
</div>
...
<section style="background-image:url('IMAGES/bg.png'); background-repeat: no-repeat;">
 ...
 Many people look for Property for a variety of purpose like Residential,offices,schools and other uses.</p>
                ...
                <a href="https://www.instagram.com/"><i class="fab fa-instagram" style="color:black;margin-left:-10px;font-size:30px"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="https://www.linkedin.com/"><i class="fab fa-linkedin" style="color:black;margin-left:700;font-size:30px "></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="https://www.linkedin.com/"><i class="fab fa-linkedin" style="color:black;margin-left:700;font-size:30px "></i></a>

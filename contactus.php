...
<html>
<head>
<title>real estate::contactus</title>
<!--
...
<header>
  ...
  <div class="header-right">
    <nav class="navbar">
      ...
      <a class="active1" href="contactus.php">Contact us</a>
...
<div class="contactuscontainer">
  <h1 style="text-align:center; font-family: Verdana, Geneva, Tahoma, sans-serif;">&nbsp;&nbsp;Get in touch !</h1>
  <div class="contactusrow">
     <div class="contactuscolumn">
         <div class="contactuscard"  >
           <h2 style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Contact Us </h2>
           <h4><i class="fas fa-map-marker-alt"></i> Address</h4>
          
           <p style="font-size:medium;font-family:monospace">Hukkeri,Belagavi</p>
           <p  style="font-size:medium;font-family:monospace">Raybag,Belagavi</p>
         
     
           <h4><i class="fas fa-phone-square-alt"></i> Call Us</h4>
           <p  style="font-size:medium;font-family:monospace">8867111632</p>
           <p style="font-size:medium;font-family:monospace">6362493176</p>
        
     
           <h4><i class="fas fa-envelope-square"></i> Email</h4>
           <p style="font-size:medium;font-family:monospace">priyankahanje10@gmail.com</p>
           <p style="font-size:medium;font-family:monospace">muktak7422@gmail.com</p>
         </div>
       </div>
 </div>
</div>
        ...
        <div class="contactusformcolumn">
          <form action="#" method="post" name="myForm" onsubmit="return formValidate1()" >
            <label>Full Name</label>
            <input type="text"  name="fname" id="fname" placeholder="Your full name.."><br>
            <label>Mobile Number</label>
            <input type="text"  name="mob" id="mob"placeholder="Your Mobile Number.."><br>
            <label>Email ID</label>
            <input type="text" name="email" id="email"placeholder="Your Email ID.."><br>
            <label>Query</label><br>
            <textarea  id="query" name="query" placeholder="Write Query here .." style="height:170px; width:31%;"></textarea>
            <br><br>
...
if(isset($_POST['qsubmit']))
{
  ...
  if(!$connect)
  {
    ...
    $query="insert into query values('$fname','$mob','$email','$query')";
   
   $result=mysqli_query($connect,$query) or die('error in insertquery');
   if($result==1)
   {
    echo'<script>';
    echo'swal("Thank you","your query is submitted","success")';
    echo'</script>';
   }else{
    
      echo'<script>';
      echo'swal("Sorry","your query is not submitted","error")';
      echo'</script>';
    }
   }
   }
...
?>
    ...
    <div class="maprow">
      <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1BeL-d8S89UU0X9ixC9RwRybRFMoHR6s&ehbc=2E312F" width="100%" height="400"></iframe>
    </div>
<!--start of footer -->
<footer>

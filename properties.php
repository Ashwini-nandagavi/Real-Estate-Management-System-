...
<header>
  ...
  <div class="header-right">
    ...
    <a class="active1" href="properties.php">Properties</a>
...
<div class="search1"></div>
  <div class="search2" style="background: transparent;">
    <input type="text" name="input"  placeholder="Search by property name..."  class="search-text-box">
    <input type="submit" name="search" name="search-btn" value="Search" style="color:black;background:white;background-color:#327dc0;">
</div>
</form> 

  <h2 style="text-align:center;text-decoration:underline">--Property Details--</h2><br><br>
  ...
  <tr>
    ...
    if(!$connect)
    {
      ...
      {
            $input = $_POST['input'];
            $pquery="select * from addproperty where pname='$input'";
...
<?php
      ...
      $pquery="select * from addproperty limit 1,4";
      $result=mysqli_query($connect,$pquery) or die("could not execute query");
      while($row=mysqli_fetch_array($result))
      {
...
<?php
 {
      ...
      $pquery="select * from addproperty limit 5,4";
      $result=mysqli_query($connect,$pquery) or die("could not execute query");
      while($row=mysqli_fetch_array($result))
      {
